...
try:
    ...
    from .NewLoss.ioulossone import nwd, bbox_shape_iou, bbox_mpdiou,  bbox_piou, nwdiou, bbox_effciou, bbox_xiou
...
class BboxLoss(nn.Module):
    ...
    def forward(self, pred_dist, pred_bboxes, anchor_points, target_bboxes, target_scores, target_scores_sum, fg_mask):
        ...
        try:
            ...
            # 一类IoU损失函数
            if useloss == 'CIoU':
                iou = bbox_multi_iou(pred_bboxes[fg_mask], target_bboxes[fg_mask], CIoU=True, is_Focaler='None') # 🎈 对应IoU损失函数注释即可运行代码
            elif useloss == 'NWD':
                iou = bbox_iou(pred_bboxes[fg_mask], target_bboxes[fg_mask], xywh=False, CIoU=True)
